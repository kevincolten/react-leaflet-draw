...
var EditControl_EditControl = /*#__PURE__*/function (_MapControl) {
  ...
  _createClass(EditControl, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      _get(_getPrototypeOf(EditControl.prototype), "componentDidUpdate", this).call(this, prevProps); // If the props haven't changed, don't update


      if (lodash_es_isEqual(this.props.draw, prevProps.draw) && lodash_es_isEqual(this.props.edit, prevProps.edit) && this.props.position === prevProps.position) {
        return false;
      }
      ...
      this.leafletElement.addTo(map); // Remount the new draw control
